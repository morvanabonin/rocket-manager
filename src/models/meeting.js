        ...
        return new Promise((resolve, reject) => {
            ...
            (cb) => {
                ...
                bot.startConversation(message, (err, convo) => {
                    //convo.say('Hello @' + participant.name + ', it is your turn now.');
                    convo.say('Olá @' + participant.name + ', é sua vez agora.');
                    ...
                    convo.say('Obrigado(a) @' + participant.name + '!');
                ...
                bot.say({
                    ...
                    text: 'Daily finalizada. Resultado será enviado para o e-mail ' +
                        config.get('mail:to'),
                    channel: that.channelId
                });
